    ...
    <Layout>
      <main className="2xl:container mx-auto flex flex-col items-center justify-start min-h-[42rem] md:min-h-[39rem] lg:min-h-[39rem]">
        ...
        <div className="bg-slate-50 mx-8 rounded-3xl p-4 translate-y-32 absolute md:mx-20 md:p-6 dark:bg-slate-800">
          <section className="">
            <h2 className="text-slate-700 font-bold text-xl md:text-[1.4rem] dark:text-slate-400 md:mb-1">
              {" "}
              درباره من
            </h2>
          ...
          <section className="">
            <h2 className="text-slate-700 font-bold text-xl my-3 dark:text-slate-400">
              {" "}
              مهارت ها
            </h2>
          ...
          <section className="flex flex-col mb-2">
            ...
            <div className="flex flex-col w-full items-start justify-center lg:mb-2 ">
              <div className="flex items-center">
                ...
                <p
                  dir="ltr"
                  className="text-slate-700 text-sm dark:text-slate-500">
                  {convertToPersianNumber("0990 618 2988")}
                </p>
              </div>
              <div className="flex items-center my-4">
                ...
                <p
                  dir="ltr"
                  className="text-slate-700 text-sm dark:text-slate-500">
                  abolfazlkhosravi.2003jun@gmail.com
                </p>
              </div>
            </div>
          </section>
          <section className=" flex justify-between items-center">
            <button
              className="py-2 bg-blue-500 rounded-2xl text-slate-100 font-bold px-12 hover:scale-105 transition-all cursor-pointe"
